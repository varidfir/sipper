...
<main class="sipper-content">
    <div style="padding:24px">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:12px">
            <h2 style="margin:0">Data Kecamatan</h2>
            <a href="{{ route('kecamatan.create') }}" style="padding:8px 12px;border-radius:8px;background:#2563eb;color:#fff;text-decoration:none">Tambah Kecamatan</a>
        </div>
        ...
        <table style="width:100%;border-collapse:collapse">
            <thead>
                <tr style="text-align:left;border-bottom:1px solid #e6eef8">
                    ...
                    <th style="padding:8px">Nama Kecamatan</th>
            ...
            <tbody>
                @foreach($kecamatans as $kecamatan)
                    <tr>
                        ...
                        <td style="padding:8px">{{ $kecamatan->nama_kecamatan }}</td>
                        <td style="padding:8px">
                            <a href="{{ route('kecamatan.edit', $kecamatan) }}" style="margin-right:8px;color:#2563eb">Edit</a>
