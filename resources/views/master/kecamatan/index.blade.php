            ...
            <div class="border-b border-slate-200 px-5 py-4 sm:px-6">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('kecamatan.create') }}" class="rounded-xl border border-blue-600 bg-blue-600 px-4 py-2 text-center text-sm font-bold text-white transition hover:bg-blue-700">
                            + Tambah
                        </a>
            ...
            <div class="p-5 sm:p-6">
                <section class="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-5">
                    <div class="border-b border-slate-200 pb-3">
                        <h2 class="font-bold text-slate-900">Daftar Kecamatan</h2>
                        <p class="mt-1 text-xs text-slate-500 sm:text-sm">{{ $kecamatans->count() }} kecamatan terdaftar</p>
                    </div>
                    ...
                    <div class="mt-4">
                        @forelse($kecamatans as $kecamatan)
                            <div class="mb-3 flex flex-col gap-2 rounded-xl border border-slate-200 bg-white p-4 sm:flex-row sm:items-center sm:justify-between">
                                <div class="flex-1">
                                    <p class="font-semibold text-slate-900">{{ $kecamatan->nama_kecamatan }}</p>
                                </div>
                        ...
                        @empty
                            <p class="py-8 text-center text-sm text-slate-500">Belum ada data kecamatan</p>
                        @endforelse
                    </div>
                </section>
            </div>
