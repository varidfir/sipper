...
<style>
    .jenis-form-page { min-height: 100vh; padding: 18px clamp(16px, 3vw, 32px) 32px; background: var(--sip-bg); }
    ...
    .jenis-form-kicker { margin: 0 0 4px; color: var(--sip-primary); font-size: 10px; font-weight: 800; letter-spacing: .12em; text-transform: uppercase; }
    ...
    .jenis-section-title { padding: 10px 12px; background: var(--sip-sidebar-bg); color: #fff; font-size: 13px; font-weight: 700; }
    ...
    .jenis-field input:focus { border-color: var(--sip-primary); outline: 0; box-shadow: 0 0 0 2px rgba(29, 97, 232, .12); }
    .jenis-form-actions { display: flex; justify-content: flex-end; gap: 8px; padding: 0 16px 16px; }
    .jenis-save { min-height: 35px; padding: 0 16px; border: 1px solid var(--sip-primary); border-radius: 3px; background: var(--sip-primary); color: #fff; font-size: 12px; font-weight: 700; cursor: pointer; }
    .jenis-save:hover { background: var(--sip-primary-hover); }
